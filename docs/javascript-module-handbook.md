...
AMD 全称为 *Asynchronous Module Definition*，意为*异步模块定义*，RequireJS 是其最佳实践者，其核心思路是：
...
UMD 全称是 *Universal Module Definition*，意为通*用模块定义*，该模式主要用于解决 AMD 与 CJS 模式不通用的问题，同时支持 IIFE 模式。
